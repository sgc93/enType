...
const jsCode =
	"var let const function return if else for in while do switch case break continue try catch throw finally typeof null undefined true false NaN Infinity async await new this super class extends prototype static".split(
		" "
	);
...
const dartCode =
	"class enum abstract extends implements final super this static const var void return new if else for in while do switch case break continue try catch throw assert null true false dynamic void Function Object String int double num bool List Map Set Runes Symbol".split(
		" "
	);
...
const cCode =
	"auto double int struct break else long switch case enum register typedef char extern return union const float short unsigned continue for signed void default goto sizeof volatile do if static while".split(
		" "
	);
